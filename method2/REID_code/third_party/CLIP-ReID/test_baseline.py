...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ReID Baseline Testing (No LoRA)")
    parser.add_argument(
    ...
    print("=> Data loaded: num_query={}, num_classes={}, camera_num={}".format(num_query, num_classes, camera_num))

    model = make_model(cfg, num_class=num_classes, camera_num=camera_num, view_num = view_num)
    
    print("=> Loading weights from: {}".format(cfg.TEST.WEIGHT))
